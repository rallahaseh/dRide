...
export class burntNFT extends ethereum.Event {
  get params(): burntNFT__Params {
    return new burntNFT__Params(this);
  }
}

export class burntNFT__Params {
  _event: burntNFT;

  constructor(event: burntNFT) {
    this._event = event;
  }
...
export class RentableVehicles extends ethereum.SmartContract {
  static bind(address: Address): RentableVehicles {
    return new RentableVehicles("RentableVehicles", address);
  }
  ...
  try_mint(_tokenURI: string): ethereum.CallResult<BigInt> {
...
export class ConstructorCall__Inputs {
  ...
  get marketplaceContract(): Address {
