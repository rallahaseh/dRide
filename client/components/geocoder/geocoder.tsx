...
import DebouncedProgressBar from './debounced.progress-bar';
...
const Geocoder = ({
  ...
  const renderSuggestionsContainer = useCallback(
    (options: { containerProps: any; children: any; }) => {
  ...
  const renderSuggestion = useCallback((suggestion: { label: string; }, { query, isHighlighted }: any) => {
